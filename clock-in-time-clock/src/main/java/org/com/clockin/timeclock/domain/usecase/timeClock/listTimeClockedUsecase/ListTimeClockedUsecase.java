...
public class ListTimeClockedUsecase {
    ...
    private final AggregateTimeClockList aggregateTimeClockedByDay;
    ...
    private ListTimeClockedOutput mountOutput(Page<TimeClock> timeClocks, String startDate, String endDate, Employee employee) {
        LinkedHashMap<String, TimeClockListDTO> timeClockeds = aggregateTimeClockedByDay.execute(timeClocks.getContent(), employee);
