    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable).authorizeHttpRequests(req ->
            req.dispatcherTypeMatchers(DispatcherType.ERROR).permitAll()
                ...
                .requestMatchers("/employee/enable/{employeeId}").hasAnyAuthority("ROLE_realm_ceo", "ROLE_realm_human_resources", "ROLE_realm_manager")
                ...
                .requestMatchers("/employee/{employeeId}/itinerary").hasAnyAuthority("ROLE_realm_ceo", "ROLE_realm_human_resources", "ROLE_realm_manager")
