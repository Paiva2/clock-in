...
public class GetEmployeeProfileUsecase {
    ...
    public EmployeeOutput execute(String employeeResourceServerId) {
        ...
        return mountOutput(employee, personalData, employeeManagers);
    }
    ...
    private EmployeeOutput mountOutput(Employee employee, PersonalData personalData, List<EmployeeManager> managers) {
